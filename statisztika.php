...
if (isset($_GET['day'])) {
    ...
    if ($napistatisztika) {
        ...
        echo '<p>Átlagos napi kalória (' . $kivnap . '): '. $napistatisztika[0]['atlagos_kaloria'] . '</p>';
        echo '<p>Összes elfogyasztott kalória: ' . $napistatisztika[0]['osszeg_kaloria'] . '</p>';
    } else {
...
echo '<h3><p>Átlagos napi kalória: ' . $averageCaloriesPerDay['atlagos_kaloria'] . '</h3></p>';

$legkaloriadusabb = getLegCaloricFood();
echo '<h3><p>A legkalóriadús étel: ' . $legkaloriadusabb['nev'] . ' (' . $legkaloriadusabb['kaloria'] . ' kalória)</h3></p>';
?>
